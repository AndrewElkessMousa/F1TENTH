...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'plot_controller_path_comparison = neural_network_control.plot_controller_path_comparison:main',
            'target_point_step_response_report = neural_network_control.target_point_step_response_report:main',
        ],
    },
)
